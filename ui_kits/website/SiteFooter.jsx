    ...
    <footer style={{ background: "var(--surface-ink)", color: "var(--text-on-ink)" }}>
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "64px 48px 40px", display: "grid", gridTemplateColumns: "1.2fr 1fr 1fr", gap: 48 }}>
        <div>
          ...
          <p style={{ fontFamily: "var(--font-serif)", fontSize: 15, lineHeight: 1.6, color: "var(--text-on-ink-muted)", maxWidth: "34ch", margin: 0 }}>
        ...
        <div>
          ...
          <p style={{ fontFamily: "var(--font-mono)", fontSize: 13, lineHeight: 1.8, color: "var(--text-on-ink-muted)", marginTop: 14 }}>
            Campo Arroyo del Medio<br />Bariloche · Patagonia<br />Argentina
          </p>
          <div style={{ marginTop: 18 }}>
            <Eyebrow tone="onInk">Dirección</Eyebrow>
            <p style={{ fontFamily: "var(--font-mono)", fontSize: 13, color: "var(--text-on-ink-muted)", marginTop: 12 }}>Roxana Galand</p>
          </div>
        </div>
        <div>
          <Eyebrow tone="onInk">Boletín</Eyebrow>
          <p style={{ fontFamily: "var(--font-serif)", fontSize: 14, color: "var(--text-on-ink-muted)", margin: "12px 0 14px" }}>
      ...
      <div style={{ borderTop: "1px solid rgba(255,255,255,0.12)", padding: "20px 48px", maxWidth: 1280, margin: "0 auto", display: "flex", justifyContent: "space-between" }}>
        <span style={{ fontFamily: "var(--font-mono)", fontSize: 11, letterSpacing: "0.1em", color: "var(--text-on-ink-faint)" }}>© 2026 NFCD</span>
        <span style={{ fontFamily: "var(--font-mono)", fontSize: 11, letterSpacing: "0.1em", color: "var(--text-on-ink-faint)" }}>Instagram · Contacto</span>
      </div>
    </footer>
  );
}
