  ...
  return (
    <section style={{ maxWidth: 1280, margin: "0 auto", padding: "76px 48px", display: "grid", gridTemplateColumns: "0.85fr 1.15fr", gap: 52, alignItems: "center" }}>
      <div style={{ display: "flex", justifyContent: "center", position: "relative" }}>
        <img className="nfcd-logo-light" src="../../recursos/logos/nfcd_isologov1_color_fondotrasparente.png" alt="Naturaleza de la Fuerza"
          style={{ maxWidth: "100%", maxHeight: 380 }} />
        <img className="nfcd-logo-dark" src="../../recursos/logos/nfcd_isologov1_blanco_fondotrasparente.png" alt="Naturaleza de la Fuerza"
