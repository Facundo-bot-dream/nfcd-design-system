  ...
  return (
    <header style={{
      ...
      <a href="#" onClick={(e)=>{e.preventDefault(); onNav&&onNav("home");}} style={{ display: "flex", alignItems: "center", position: "relative", height: 46 }}>
        <img className="nfcd-logo-light" src="../../recursos/logos/nfcd_isologov2_color_fondotrasparente.png" alt="NFCD" style={{ height: 46 }} />
        <img className="nfcd-logo-dark" src="../../recursos/logos/nfcd_isologov2_blanco_fondotrasparente.png" alt="NFCD" style={{ height: 46 }} />
      </a>
