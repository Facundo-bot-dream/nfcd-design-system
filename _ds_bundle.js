...
function Accordion({
  ...
  }, open ? labelOpen || label : label), /*#__PURE__*/React.createElement("svg", {
    viewBox: "0 0 24 24",
    width: "25",
    height: "25",
    fill: "none",
...
Object.assign(__ds_scope, { Accordion, __ds_default_components_content_Accordion_18e75py: Accordion });
...
function Badge({
  ...
  const palette = {
    wine: {
      strong: "var(--chip-wine-solid)",
      soft: "var(--chip-wine-bg)",
      softText: "var(--chip-wine-text)",
      line: "var(--chip-wine-line)"
    },
    ink: {
      strong: "var(--chip-ink-solid)",
      soft: "var(--chip-ink-bg)",
      softText: "var(--chip-ink-text)",
      line: "var(--chip-ink-line)"
    },
    sage: {
      strong: "var(--chip-sage-solid)",
      soft: "var(--chip-sage-bg)",
      softText: "var(--chip-sage-text)",
      line: "var(--chip-sage-line)"
    }
  }[tone];
  const styles = variant === "solid" ? {
    background: palette.strong,
    color: "var(--chip-on-solid)",
...
function MobileCarousel({
  ...
  const slides = items.length > 0 ? items.map((item, idx) => /*#__PURE__*/React.createElement("div", {
    key: idx,
    "data-slide": true,
    role: "group",
  ...
  }, item)) : React.Children.map(children, (child, idx) => /*#__PURE__*/React.createElement("div", {
    key: idx,
    "data-slide": true,
    role: "group",
    "aria-label": `Slide ${idx + 1} of ${slideCount}`,
  ...
  }, slides), showArrows && slideCount > 1 && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("button", {
    type: "button",
    onClick: handlePrev,
  ...
  })))), showDots && slideCount > 1 && /*#__PURE__*/React.createElement("div", {
    role: "tablist",
    style: {
      position: "absolute",
      bottom: "16px",
...
Object.assign(__ds_scope, { MobileCarousel, __ds_default_components_content_MobileCarousel_1u78ixm: MobileCarousel });
...
function Tag({
  ...
  const tones = {
    wine: {
      background: "var(--chip-wine-bg)",
      color: "var(--chip-wine-text)",
      border: "1px solid var(--chip-wine-line)"
    },
    ink: {
      background: "var(--chip-ink-bg)",
      color: "var(--chip-ink-text)",
      border: "1px solid var(--chip-ink-line)"
    },
    sage: {
      background: "var(--chip-sage-bg)",
      color: "var(--chip-sage-text)",
      border: "1px solid var(--chip-sage-line)"
    }
  };
  return /*#__PURE__*/React.createElement("span", _extends({
    style: {
...
function Hero() {
  return /*#__PURE__*/React.createElement("section", {
    ...
    style: {
      maxWidth: "100%",
      maxHeight: 460,
      mixBlendMode: "var(--img-graphite-blend)"
    }
  })));
}
window.Hero = Hero;
