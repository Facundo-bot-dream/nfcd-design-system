...
function SiteHeader({ onNav }) {
  ...
  return /* @__PURE__ */ React.createElement("header", { style: {
    ...
    e.preventDefault();
    onNav && onNav("home");
  }, style: { display: "flex", alignItems: "center", position: "relative", height: 46 } }, /* @__PURE__ */ React.createElement("img", { className: "nfcd-logo-light", src: "../../assets/logos/nfcd_isologov2_color_fondotrasparente.png", alt: "NFCD", style: { height: 46 } }), /* @__PURE__ */ React.createElement("img", { className: "nfcd-logo-dark", src: "../../assets/logos/nfcd_isologov2_blanco_fondotrasparente.png", alt: "NFCD", style: { height: 46, position: "absolute", left: 0, top: 0 } })), /* @__PURE__ */ React.createElement("nav", { style: { display: "flex", alignItems: "center", gap: 30 } }, links.map((l) => /* @__PURE__ */ React.createElement("a", { key: l, href: "#", onClick: (e) => e.preventDefault(), style: {
    fontFamily: "var(--font-mono)",
    fontSize: 12,
    letterSpacing: "0.14em",
    textTransform: "uppercase",
